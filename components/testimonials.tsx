...
const testimonials = [
  {
    name: "Sarah Mitchell",
    role: "Homeowner",
    content: "Prestige Cleaning By Caro has completely transformed my home. Their attention to detail is remarkable, and I love that they use eco-friendly products. It's like coming home to a spa every time!",
    rating: 5,
    image: "SM",
  },
  {
    name: "Michael Chen",
    role: "Business Owner",
    content: "As a business owner, first impressions matter. Prestige Cleaning By Caro keeps our office spotless and professional. Our clients always comment on how clean and welcoming our space feels.",
    rating: 5,
    image: "MC",
  },
  {
    ...
    role: "Working Mom",
    content: "Between work and kids, I never have time to clean properly. Prestige Cleaning By Caro gives me my weekends back while keeping our home healthy and safe for my family. They're absolute lifesavers!",
    rating: 5,
    image: "ER",
  },
  {
    ...
    content: "Managing multiple properties requires reliable cleaning services. Prestige Cleaning By Caro has been our go-to for over 3 years now. Consistent quality, professional staff, and great communication.",
    rating: 5,
    image: "DT",
  },
  {
    ...
    content: "I recommend Prestige Cleaning By Caro to all my clients. They understand the importance of maintaining beautiful spaces. Their deep cleaning service is exceptional and reasonably priced.",
    rating: 5,
    image: "JP",
  },
]
